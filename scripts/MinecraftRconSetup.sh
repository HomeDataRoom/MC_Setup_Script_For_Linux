...
bash
sed -i "s/rcon.password=/rcon.password=$rpass/g" /opt/minecraft/server.properties
sed -i "s/enable-rcon=false/enable-rcon=true/g" /opt/minecraft/server.properties
exit
exit
EOF
